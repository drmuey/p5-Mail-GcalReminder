...
#   public iCal : https://www.google.com/calendar/ical/6qrhpfk1utcs97g9u2o27g5ojo%40group.calendar.google.com/public/basic.ics
#   private iCal: https://www.google.com/calendar/ical/6qrhpfk1utcs97g9u2o27g5ojo%40group.calendar.google.com/private-a6689d558b4dbba8942e510985b604d3/basic.ics
my $pub_ical_gcal  = '6qrhpfk1utcs97g9u2o27g5ojo%40group.calendar.google.com/public';
my $priv_ical_gcal = '6qrhpfk1utcs97g9u2o27g5ojo%40group.calendar.google.com/private-a6689d558b4dbba8942e510985b604d3';

$gcr->base_date( DateTime->new( month => 1, day => 21, year => 1986, time_zone => 'America/Chicago' ) );

# diag($gcr->base_date);

my $priv_cal = $gcr->get_gcal($priv_ical_gcal);

# diag( explain($priv_cal) );

is( ref($priv_cal), 'HASH', 'get_gcal() returns hash' );
is( $priv_cal, $gcr->get_gcal($priv_ical_gcal), 'gcal is cached from first call on' );

my $pub_cal      = $gcr->get_gcal($pub_ical_gcal);
my $priv_trg_ref = _get_target_datastruct($priv_ical_gcal);
my $pub_trg_ref  = _get_target_datastruct($pub_ical_gcal);
...
my $pub = $gcr->get_gcal($pub_ical_gcal);
